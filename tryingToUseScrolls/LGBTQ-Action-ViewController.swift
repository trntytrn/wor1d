...
class LGBTQ_Action_ViewController: UIViewController {
    ...
    @IBAction func segeValChanged(_ sender: Any) {
        if Sege.selectedSegmentIndex == 0 {
            ...
            label1.text = "The Trevor Project"
            ...
            label1.text = "The Trevor Project needs crisis counselors!"
            label2.text = "Volunteer Resources 2"
            label3.text = "Volunteer Resources 3"
            label4.text = "Volunteer Resources 4"
            label5.text = "Volunteer Resources 5"
        } else if Sege.selectedSegmentIndex == 3 {
            label1.text = "Catalyst Data to Know"
